    ...
    <div class="w-[100%] h-[905px] bg-[#0a0f16] pt-[330px] flex justify-center relative">
        ...
        <div class="text-[#d4cdcd] w-[1290px] h-[444px] flex flex-row justify-between">
            <div class="w-[375px]">
                ...
                <h2 class="text-[21px] leading-[1.62] mb-[25px]">Neobyte Design is one of the leading website design agencies, driving creative and cutting-edge web solutions.</h2>
                <div class="flex flex-row mb-[25px] gap-[15px]">
                    <img src={phone_icon} alt="">
                    <a href="tel:+959459170740" class="text-[#fff] opacity-[0.7] hover:opacity-[1] transition duration-300">+959459170740</a>
                </div>
                <div class="flex flex-row mb-[25px] gap-[15px]">
            ...
            <div class="w-[785px] flex flex-row justify-between">
                ...
                <div class="flex flex-col gap-[20px] mt-[15px]">
                    <h3 class="mb-[20px] text-[#fff] text-[24px] font-semibold leading-[1.375]">Quick Links</h3>
                ...
                <div class="flex flex-col gap-[20px]  mt-[15px]">
                    ...
                    <a class="hover:text-[#fff] transition duration-300" href="/refund-policy">Refund Policy</a>
                    <a class="hover:text-[#fff] transition duration-300" href="/privacy-policy">Privacy Policy</a>
                    <a class="hover:text-[#fff] transition duration-300" href="/terms-conditions">Terms & Conditions</a>
                </div>
                <div></div>
            </div>
        </div>
    </div>
    <div class="w-[100%] h-[93px] bg-[#151c25] flex justify-center items-center text-[#fff] font-medium text-[18px] leading-[1.28]">Copyright © 2024 Neobyte Design</div>
</footer>